...
- The camera is always the **stock Roblox classic camera with a free cursor**; there is no custom camera code outside the kill cam. During combat the orange crosshair follows the mouse cursor and aiming is a raycast from the camera through the cursor.
